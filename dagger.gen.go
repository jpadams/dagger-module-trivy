...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Trivy":
		...
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"name\":\"Base\",\"returnType\":{\"asObject\":{\"functions\":[{\"name\":\"TrivyScan\",\"returnType\":{\"kind\":\"StringKind\"}}],\"name\":\"Container\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Trivy\"},\"kind\":\"ObjectKind\"}")
